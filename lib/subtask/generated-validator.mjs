// Generated by scripts/generate-schema-validators.mjs from dev-task.schema.yaml.
// Do not edit manually. YAML schemas are the ADR-0026 cross-runtime contract source.

const SCHEMA_NAME = "dev-task";
const ROOT_TYPE = "markdown_with_frontmatter";
...
const FIELD_RULES = [
  ...
  {
    "name": "dependencies",
    "type": "array_of_task_id",
    "note": "stored as YAML inline list text for Console frontmatter parser compatibility"
  },
  {
    "name": "source_breakdown_draft",
    "type": "relative_path"
  },
  {
    "name": "source_draft_hash",
    "type": "sha256_hex"
  },
  {
    "name": "created_at",
...
const BODY_RULE = {
  "type": "markdown_min_50_chars_with_heading_or_list",
  "required": true
};
...
export function validateDevTask(input) {
