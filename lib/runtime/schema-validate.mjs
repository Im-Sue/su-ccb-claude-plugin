...
function validateRequirementFrontmatter(content) {
  ...
  const hasAnalysisInputHash = frontmatter.analysis_input_hash !== undefined;
  const hasAnalysisAppliedAt = frontmatter.analysis_applied_at !== undefined;
  if (hasAnalysisInputHash || hasAnalysisAppliedAt) {
