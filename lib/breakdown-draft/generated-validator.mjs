// Generated by scripts/generate-schema-validators.mjs from breakdown-draft.schema.yaml.
// Do not edit manually. YAML schemas are the ADR-0026 cross-runtime contract source.

const SCHEMA_NAME = "breakdown-draft";
...
const FIELD_RULES = [
  ...
  {
    "name": "carrier_task_id",
    "type": "non_empty_string"
  },
  {
    "name": "carrier_task_key",
    "type": "non_empty_string"
  },
  {
    "name": "base_task_revision",
...
export function validateBreakdownDraft(input) {
