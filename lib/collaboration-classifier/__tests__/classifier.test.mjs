...
test("classifier_coverage partial floors result to standard and cannot be lite", () => {
  const diff = [
    ...
    "@@ -1 +1 @@",
    "+<update id=\"writePoint\">UPDATE point_account SET balance = balance + 1</update>"
  ].join("\n");
