// Generated by scripts/generate-schema-validators.mjs from anchor-dispatch.schema.yaml.
// Do not edit manually. YAML schemas are the ADR-0026 cross-runtime contract source.

const SCHEMA_NAME = "anchor-dispatch";
...
export function validateAnchorDispatch(input) {
