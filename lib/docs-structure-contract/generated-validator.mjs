// Generated by scripts/generate-schema-validators.mjs from docs-structure-contract.schema.yaml.
// Do not edit manually. YAML schemas are the ADR-0026 cross-runtime contract source.

const SCHEMA_NAME = "docs-structure-contract";
...
const FIELD_RULES = [
  {
    "name": "version",
    "type": "literal",
    "value": "docs-structure-contract-v0.1"
  },
  {
    "name": "human_docs",
    "type": "object",
...
export function validateDocsStructureContract(input) {
