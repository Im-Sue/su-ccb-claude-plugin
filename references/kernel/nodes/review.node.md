...
15. 我是否区分了测试通过和验收满足？
16. 我是否说明了 unknown 项？
17. 我是否选择了 pass/request changes/replan/escalate？
18. 如果 request changes，我是否写了可派发返工 brief？
19. 如果 pass，我是否写了通过理由？
20. 如果 replan，我是否说明回到哪个节点？
21. 我是否记录了剩余风险？
22. 我是否没有在 review 中擅自重新实现？
23. 我是否没有把高风险隐藏进归档？
24. 我是否记录了 EventJournal？
25. 用户能否理解为什么通过或为什么打回？
26. 若审查对象含 requirement/technical_design 文档产物：目标对齐首屏能让用户秒懂吗？
27. 若含文档产物：模拟示例存在，或豁免理由（「无需示例，因为…」）站得住吗？
28. 若含文档产物：黑话首现都带白话解释吗（document-expression-spec R4）？
